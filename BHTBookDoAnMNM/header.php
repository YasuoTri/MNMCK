        ...
        <div class="container">
            <div class="user-menu">
                <ul>
                    ...
                    <li><a href="./admin/index.php"><i class="fas fa-user-shield"></i> Trang quản trị</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="shopping-item">
                        <a href="<?='./cart.php'?>">Giỏ hàng - <span
                                class="cart-amunt"><?=Helper::Currency($totalMoney)?></span>
